...
public class PlaylistAdapterHorizontal extends RecyclerView.Adapter<PlaylistAdapterHorizontal.PlaylistViewHolder> {
    private Context context;
    private List<PlaylistModel> playlists;
    private OnItemClickListener listener;

    public PlaylistAdapterHorizontal(Context context, List<PlaylistModel> playlists) {
    ...
    public PlaylistViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.item_playlist_horizontal, parent, false);
